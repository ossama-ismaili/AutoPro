...
using AutoPro.Models.viewModel;
...
namespace AutoPro.Controllers
{
    ...
    public class VoituresController : Controller
    {
        ...
        public VoituresController(AutoProContext context ,HostingEnvironment hostingEnvironment, IStringLocalizer<VoituresController> localizer)
        {
            _context = context;
